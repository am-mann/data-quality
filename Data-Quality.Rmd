...
Can sex differences in frequency of 0 secondary factors listed be explained by cause of death and/or age of death?
```{r}
mort <- mortality %>% 
  mutate(
...
mort <- mortality %>%
  ...
  # 3a) no secondary factors flag (1=yes none; 0=has ≥1)
  mutate(
