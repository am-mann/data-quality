...
membership_ri_file   <- here::here("output", "county_cluster_membership.csv")       # RI membership
...
metrics2_file        <- here::here("data",   "county_year_quality_metrics.csv")     # contains RI_post_only by fips/year/period
...
ri_candidates <- c("RI_post_only","ri_post_only","ri_post","ri")
