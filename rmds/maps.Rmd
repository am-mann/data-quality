...
comp_vars_pct <- c("pct_marstat_comp_k", "pct_placdth_comp_k", "pct_educ_comp_k", "pct_mandeath_comp_k","pct_age_comp_k", "pct_sex_comp_k", "pct_race_comp_k", "DQ_B_overall")
...
quality_vars <- c(
  "prop_garbage", "prop_light", "pct_overd_miss", "prop_all_comp", "DQ_B_overall"
)
...
res <- res %>%
  mutate(
    direction_score =
      (z_prop_garbage + z_prop_light + z_pct_overd_miss -
      z_prop_all_comp - z_DQ_B_overall)/6
  )
